...
<div class="max-w-4xl space-y-6">
    ...
    <div class="flex items-center space-x-2">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white tracking-tight">Add New Project</h1>
            <p class="text-zinc-400 text-sm mt-1">Tambahkan proyek baru Anda lengkap dengan deksripsi teknis dan media pendukung.</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="full_description" id="full_description" rows="6" required
                    class="w-full px-4 py-2 bg-zinc-950/60 border border-zinc-800 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition duration-200"
                    placeholder="Detailed explanation of features, architecture, challenges..."></textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="tech_tags" id="tech_tags" value="{{ old('tech_tags') }}" required
                        class="w-full px-4 py-2 bg-zinc-950/60 border border-zinc-800 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition duration-200"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="url" name="live_link" id="live_link" value="{{ old('live_link') }}"
                        class="w-full px-4 py-2 bg-zinc-950/60 border border-zinc-800 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition duration-200"
                        placeholder="https://...">
                </div>
            </div>
