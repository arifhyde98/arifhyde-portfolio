...
<div class="max-w-2xl space-y-6">
    ...
    <div class="flex items-center space-x-2">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white tracking-tight">Edit Skill</h1>
            <p class="text-zinc-400 text-sm mt-1">Ubah data keahlian teknis Anda.</p>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="category" id="category" required
                        ...
                        <option value="Automation" {{ old('category', $skill->category) == 'Automation' ? 'selected' : '' }}>Automation</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative flex items-center">
                        <input type="number" name="percentage" id="percentage" value="{{ old('percentage', $skill->percentage) }}" min="0" max="100" required
                            class="w-full px-4 py-2 bg-zinc-950/60 border border-zinc-800 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition duration-200">
                ...
                <div>
                    ...
                    <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $skill->display_order) }}" required
                        class="w-full px-4 py-2 bg-zinc-950/60 border border-zinc-800 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition duration-200">
                </div>
            </div>
