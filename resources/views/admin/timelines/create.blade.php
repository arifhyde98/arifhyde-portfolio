...
@section('page_title', 'Add Milestone')
...
<div class="max-w-2xl space-y-6">
    ...
    <div class="flex items-center space-x-2">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white tracking-tight">Add New Milestone</h1>
            <p class="text-zinc-400 text-sm mt-1">Tambahkan data pencapaian baru pada alur waktu karir Anda.</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.timelines.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4"
                    class="w-full px-4 py-2 bg-zinc-950/60 border border-zinc-800 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition duration-200"
                    placeholder="Describe what you achieved or learned in this period..."></textarea>
            </div>
